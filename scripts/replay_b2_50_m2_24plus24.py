...
def main() -> None:
    ...
    summary = {
        "case": "B2-50 M2 24+24 physical validation",
        "route": route,
    ...
    print()
    print("=" * 76)
    print("B2-50 M2 24+24 PHYSICAL VALIDATION REPLAY")
    print("=" * 76)
    ...
    if not all_gates_pass:
        print(
            "B2-50 M2 24+24 PHYSICAL GATE: FAIL"
        )
        print(
    ...
    print(
        "B2-50 M2 24+24 PHYSICAL GATE: PASS"
    )
    print("=" * 76)
